...
usuario.nome = "Joao";
console.log(usuario); //let cria a variavel apenas para o escopo da função, não podendo utilizar fora da função
...
teste(10); //Não vai aparecer nada pois a variavel y esta apenas no escopo da função
